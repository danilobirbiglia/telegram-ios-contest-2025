...
public class ItemListSwitchItemNode: ListViewItemNode, ItemListItemNode {
    ...
    override public func didLoad() {
        ...
        } else if let switchControl = self.switchNode.view as? UIControl {
            switchControl.addTarget(self, action: #selector(self.customSwitchValueChanged(_:)), for: .valueChanged)
        }
        ...
        return { item, params, neighbors in
            ...
            return (ListViewItemNodeLayout(contentSize: contentSize, insets: insets), { [weak self] animated in
                if let strongSelf = self {
                    ...
                    strongSelf.switchNode.view.isUserInteractionEnabled = item.enableInteractiveChanges
                    ...
                    if item.displayLocked {
                        ...
                        if let _ = updatedTheme { updateLockedIconImage = true }
                        if updatedValue { updateLockedIconImage = true }
                    ...
                    if let component = item.titleBadgeComponent {
                        ...
                        let badgeSize = componentView.update(transition: .immediate, component: component, environment: {}, containerSize: contentSize)
